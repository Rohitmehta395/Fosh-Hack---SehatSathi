...
const History = ({ setLogin }) => {
  ...
  const token =
    useSelector((store) => store.token.token) || localStorage.getItem("token");
        ...
        {entries.length === 0 && !error && (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-500 mb-8">
              Analyze a medical report and it will appear here for future
              reference.
            </p>
            <button
